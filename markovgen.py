...
So if our string were "What a very lovely day",
we'd generate (What, a, very, lovely) and then (a, very, lovely, day).
        """
        if len(self.words) < 4:
            return
    ...
    def generate_markov_text(self, size=25):
        ...
        seed_word, next_word, last_word = \
            self.words[seed], self.words[seed+1], self.words[seed+2]
